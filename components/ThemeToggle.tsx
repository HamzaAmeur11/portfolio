...
export default function ThemeToggle({ variant = 'button', className = '' }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={`p-2 rounded-lg bg-gradient-to-br from-eerie-black-2 to-onyx border border-jet text-orange-yellow-crayola hover:text-white-2 hover:border-orange-yellow-crayola transition-all duration-250 ${className}`}
      aria-label="Toggle theme"
