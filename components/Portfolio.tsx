...
const projects: Project[] = [
  ...
  { title: 'OtoParking', subtitle: 'Smart parking mobile app', description: 'Cross-platform smart parking application with reservations, live availability and real-time communication.', stack: ['React Native', 'REST API', 'Socket.IO'], image: '/assets/images/project-4.png', url: 'https://www.otoparking.com', category: 'Experience' },
