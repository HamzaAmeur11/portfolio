...
const ClientReview = ({name, image, role}: Props) => {
  return (
	<div className='flex flex-col text-center justify-center' >
		...
		Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus voluptatibus magni vitae harum. Esse vel, consequuntur obcaecati, asperiores temporibus ipsam accusamus dolore amet reprehenderit perspiciatis est similique ullam distinctio totam!
		</p>
	</div>
  )
}
