		...
		<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[80%] mx-auto items-center gap-[3rem] mt-[4rem] text-white'>
			<div data-aos="fade-right">
				<div className='bg-red-700 hover:scale-110 transform transition-all duration-300 hover:-rotate-6 uppercase font-semibold text-center p-[2rem]'>
					...
					<p className='text-[15px] text-[#d3d2d2]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos itaque quos, odio praesentium nesciunt id cupiditate repellendus vero. Ad, non. Laborum iure laudantium corrupti inventore nobis pariatur numquam aliquam. Voluptatibus!</p>
				</div>
			</div>
